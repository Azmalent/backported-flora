...
object ModBlocks {
    ...
    fun register(registry: IForgeRegistry<Block>) {
        ...
        if (ModConfig.Seaweed.kelpEnabled) registry.register(BlockKelp())
    ...
    fun registerItemBlocks(registry: IForgeRegistry<Item>) {
        ...
        if (ModConfig.Seaweed.kelpEnabled) registry.register(KELP.createItemBlock())
    ...
    fun registerModels() {
        ...
        if (ModConfig.Seaweed.kelpEnabled) KELP.registerItemModel()
